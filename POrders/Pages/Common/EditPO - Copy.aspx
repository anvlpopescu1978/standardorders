    ...
    <div class="tab-content">
      <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
          ...
          <br />
           ...
           <WebPartPages:XsltListViewWebPart CacheXslStorage="false" runat="server" SuppressWebPartChrome="True" ID="MyOrders"  IsIncluded="True" GhostedXslLink="main.xsl" ListUrl="Lists/Purchase Orders" ClientIDMode="Static" EnableViewState="false" EnableOriginalValue="true">
            <XmlDefinition>
