 ...
 <asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolderMaim">
     <asp:ScriptManagerProxy runat="server">
         <Scripts>
             ...
             <asp:ScriptReference Path="Products.js" />
         </Scripts>
         ...
         <h1 class="page-header">Products</h1>
          ...
          <div class="panel-heading">
              ...
              <div class="form-group">
                  ...
                  <button type="button" class="btn btn-primary btn-small" onclick="javascript:UpdateProducts()">Update Qty</button>
              </div>
          </div>

    <WebPartPages:XsltListViewWebPart runat="server" SuppressWebPartChrome="True" ID="ViewProducts"  IsIncluded="True" GhostedXslLink="main.xsl" ListUrl="Lists/Products" ClientIDMode="Static" EnableViewState="false" EnableOriginalValue="true">
        <XmlDefinition>
