...
function _sendEmail(poId) {
    ...
    var body = '<table style="width: 100%; color:#ffffff; font-family:\'Arial\'">' +
        ...
        ///  PARTNER
        '<tr><td  colspan="2" style="background-color:#EEEEEE; color:#000000; border-bottom:1px #EEEEEE solid;"><i>Partner</i></td></tr>' +
        // Partner Address
        '<tr>' +
        ...
        /// CLIENT AFFILIATE
        '<tr><td  colspan="2" style="background-color:#EEEEEE; color:#000000; border-bottom:1px #EEEEEE solid;"><i>Client Affiliate/Invoice To</i></td></tr>' +
        // Company name
        '<tr>' +
        '<td style="height:22px; background-color:#EEEEEE; color:#000000; vertical-align: middle; width: 200px; border-bottom:1px #EEEEEE solid;">Company Name:</td>' +
