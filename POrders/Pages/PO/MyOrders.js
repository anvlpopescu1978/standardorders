function pageContentLoad(sender, args) {
    ...
    // Configure the menu visilibity
    if ($select('UserIsAdmin').get_value() !== 'Yes' && Boolean(_spPageContextInfo.isSiteAdmin) !== true) {
        jQuery('#manageProductsMenu, #ordersAdminMenu, #currenciesAndCountriesMenu, #manageUsers').hide();
    }
}
