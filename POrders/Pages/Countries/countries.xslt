          ...
          <xsl:for-each select="/dsQueryResponse/Rows/Row">
            <tr>
              <td style="width:100px">
                  <button type="button" onclick="javascript:DeleteCountry('{@ID}')" class="btn btn-danger btn-xs">Delete</button>
              </td>
              <td>
                <button type="button" onclick="javascript:EditCountry('{@ID}')" class="btn btn-primary btn-xs" data-toggle="tooltip" data-html="true">
                  <xsl:attribute name="title">
                    <xsl:value-of select ="@Terms_x0026_Conditions" disable-output-escaping="yes" />
                  </xsl:attribute>
                  Edit
                </button>
              </td>
              ...
              <td>
                <xsl:value-of select="@DefaultCurrency" disable-output-escaping="yes"/>
              </td>
            </tr>          
         </xsl:for-each>
       </tbody>       
